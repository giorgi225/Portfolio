<template>
  <aside
    :class="`${props.isActive ? 'md:fixed md:left-[0px] bg-grayLight z-[999] shadow-xl' : 'md:fixed md:left-[-100%]'} pt-2 md:pt-0 h-max md:h-full lg:shadow-none lg:relative lg:left-0 md:min-w-[260px] md:max-w-[260px] h-full px-3 md:p-2 pr-0 transition-all`"
  >
