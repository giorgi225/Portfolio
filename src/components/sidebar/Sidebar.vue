  ...
  >
    <div class="w-full h-full flex flex-col items-start justify-between">
      <div class="flex flex-col items-start gap-4 w-full">
        <div class="hidden md:flex md:px-3 md:pt-3 lg:px-0 lg:pt-0">
          <Logo />
        </div>
        <div class="flex h-[78px] md:h-auto md:border-t md:border-b border-grayLight2 md:py-3 w-full">
          <nav
            class="nav md:h-[calc(100vh-190px)] overflow-auto no-scrollbar px-2 lg:px-0 lg:!pr-2 flex md:flex-col w-full gap-4"
          >
