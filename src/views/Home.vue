<template>
  <div
    class="grid md:grid-cols-2 lg:grid-cols-1 lg:grid-rows-[auto,1fr] h-[calc(100vh-100px)] sm:h-[calc(100vh-80px)] lg:h-full gap-6 w-full md:px-10 overflow-hidden pt-10 sm:pt-20 scale-animation"
  >
    <div class="w-full h-full md:min-w-max">
      ...
      <div class="flex items-center gap-6 mt-6 md:translate-x-[-40px]">
        <div class="w-full hidden md:flex max-w-[67px]">
          <img
            width="100"
            height="100"
