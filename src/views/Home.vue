<template>
  <div
    class="grid md:grid-cols-2 lg:grid-cols-1 lg:grid-rows-[auto,1fr] h-auto bg-red-500 sm:h-[calc(100vh-80px)] lg:h-full gap-6 w-full md:px-10 overflow-hidden pt-10 sm:pt-20 scale-animation"
  >
